...
public class Main{
    public static final String ARQUIVO_ORIGEM = "C:\\Users\\aryga\\OneDrive\\Documentos\\GitHub\\PUCPR\\3Periodo\\PerformanceSC\\Atividade-10\\Flowers\\many-flowers.jpg";
    ...
    public static void recolorirPixel(BufferedImage ImagemOriginal, BufferedImage ImagemResultado, int x, int y) {
        ...
        //se o pixel em questão for um tom de cinza, vamos aumentar o nível de vermelho em 10; o de verde diminuir
        //80, azul dimiuir 20
        if(ehNivelDeCinza(red, green, blue)) {
            ...
            //para não passar o 0 pegamos o max
...
//        todo para setar valor rgb na coordenada do pixel da imagem
